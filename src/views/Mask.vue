...
.mask {
  ...
  &__add {
    position: absolute;
    margin: 3.4rem 0.7rem 0.3rem 1.7rem;
    width: 1.4rem;
    height: 0.4rem;
    line-height: 0.4rem;
    text-align: center;
  ...
  &__cancel {
    position: absolute;
    margin: 3.4rem 0.7rem 0.3rem 3.4rem;
    width: 1.4rem;
    height: 0.4rem;
    line-height: 0.4rem;
    text-align: center;
